...
object WxQrCodeHttpsTest {
  ...
  //val appid = "wx735c5d5f6dd497a9"
  //val secret = "700f86314f8703f616983fee7adc2d2a"
  ...
  def main(args: Array[String]): Unit = {
    ...
    f1.map {
      case Some(token) =>
       //val opendId = "ovH6U0-iqoTNSpkLdV4cq6qEXUQY"//"ovH6U0-ekSODK3lqNyoru2W2KfpI"
       //val url1 = s"https://api.weixin.qq.com/cgi-bin/user/info?access_token=${token.access_token}&openid=$opendId&lang=zh_CN"
       //println(url1)
